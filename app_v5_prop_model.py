...
\"\"\")
    ...
    if uploaded is not None:
        ...
        required_cols = ["Player", "Opponent", "PropType", "Line"]
        ...
        if missing:
            ...
            for idx, row in bulk_df.iterrows():
                ...
                prop_type = str(row["PropType"]).strip()
                try:
